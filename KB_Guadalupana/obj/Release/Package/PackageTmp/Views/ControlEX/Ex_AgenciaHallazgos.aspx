         ...
         <br />     <br />  <br />     <br />
            ...
            <div class="row" >
                <h3 id="ajuridico" runat="server">Lista de expedientes con hallazgos</h3>
                 <div class="col-md-12" style="overflow-x: auto;height:1000px; "  >
                 ...
                 <div class="col-md-4" style="text-align: -webkit-right;">
                         <div style="width:60%; ">
                             ...
                             <asp:Button ID="Exportar" runat="server" Width="100%" Height="25px" CssClass="btn1" Text="Exportar" />

                             <cc1:ModalPopupExtender ID="mp1" runat="server" PopupControlID="Panl1" TargetControlID="Exportar"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Asociado">
                         ...
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Monto">
                          ...
                          <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Creador">
                           <ItemTemplate>
                           <asp:Label ID="lbluser"  Width="80px" Font-Size="10px" Text='<%# Eval("Usuario") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
