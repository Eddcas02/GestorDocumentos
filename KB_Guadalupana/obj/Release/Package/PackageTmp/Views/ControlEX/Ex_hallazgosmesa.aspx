<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ex_hallazgosmesa.aspx.cs" Inherits="KB_Guadalupana.Views.ControlEX.Ex_hallazgosmesa" %>
...
<head runat="server">
    ...
    <title> Hallazgos Mesa Encargado</title>
	...
	<nav class="nav">
		...
		<li class="li">
         ...
         <div class="row">
             ...
             <h3 style=" margin-left: 30%; margin-right: 30%;">Vista de Mesa</h3>
         </center>
             </div>
           <div class="col-md-2">
      ...
      <div class="row">
          <input type="text" id="buscarb" runat="server" placeholder="Busca por No. Crédito, Nombre, Monto o CIF" class="searchTerm"   />
                <h3 id="ajuridico" runat="server">Expedientes Encontrados</h3>
                 <div class="col-md-12" style="overflow-x: auto; height:500px;" >
                <asp:GridView ID="DGVCONHALLAZGO" CssClass="table table-striped" style="width: 100%;text-align:center" runat="server"  HeaderStyle-BackColor="#003563" HeaderStyle-ForeColor="White"
    AutoGenerateColumns="False" BorderStyle="Solid"  AllowPaging="true" PageSize="5000" OnPageIndexChanging="DGRVWPEN_PageIndexChanging" OnSelectedIndexChanged="DGRVWPEN_SelectedIndexChanged" >
                    <Columns> 
         ...
         <script>
             $(document).ready(function () {
                 $("#buscarb").on("keyup", function () {
                     ...
                     $("#DGVCONHALLAZGO tr").filter(function () {
