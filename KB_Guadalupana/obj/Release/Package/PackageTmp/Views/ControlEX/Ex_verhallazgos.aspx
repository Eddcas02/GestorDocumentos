...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-12" style="overflow-x: auto; padding-left: 20%" >
          ...
          <asp:GridView ID="DGVHALL" CssClass="table" style="width: 400px;text-align:center" runat="server"  HeaderStyle-BackColor="#003563" HeaderStyle-ForeColor="White"
    AutoGenerateColumns="False" BorderStyle="Solid"  AllowPaging="true" PageSize="10" OnPageIndexChanging="DGVHALL_PageIndexChanging" OnSelectedIndexChanged="DGVHALL_SelectedIndexChanged" OnRowDataBound="gridViewIncidente_RowDataBound" OnRowUpdating="DGVHALL_RowUpdating" >
                    <Columns>
                     ...
                     <asp:ButtonField Text="Listo" CommandName="Select" ItemStyle-Width="150" ItemStyle-CssClass="seleccionarregistrogridview">
                         ...
                         <asp:ButtonField Text="Eliminar" CommandName="Update" ItemStyle-Width="150" ItemStyle-CssClass="seleccionarregistrogridview">
                            <ItemStyle Width="150px">  </ItemStyle>
        ...
        <HeaderStyle CssClass="prueba" Width="300px" ForeColor="White"></HeaderStyle>
          ...
          <asp:GridView ID="DGVHALLVISTA" CssClass="table" style="width: 400px;text-align:center" runat="server"  HeaderStyle-BackColor="#003563" HeaderStyle-ForeColor="White"
