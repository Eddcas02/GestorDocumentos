...
<body>
  ...
  <div class="row">
    ...
    AutoGenerateColumns="False" BorderStyle="Solid" OnSelectedIndexChanged="DGRVWPEN_SelectedIndexChanged" AllowPaging="true" PageSize="15" OnPageIndexChanging="DGRVWPEN_PageIndexChanging" >
                    <Columns>
    ...
    AutoGenerateColumns="False" BorderStyle="Solid" OnSelectedIndexChanged="DGVMESA_SelectedIndexChanged" AllowPaging="true" PageSize="15" OnPageIndexChanging="DGVMESA_PageIndexChanging" >
                    <Columns>
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Fecha/Hora Desembolso">
                           <ItemTemplate>
                           <asp:Label ID="lblfecha"  Width="150px" Text='<%# Eval("gen_fechadesembolso") %>' runat="server" />
        ...
        <HeaderStyle CssClass="prueba" Width="300px" ForeColor="White"></HeaderStyle>
            ...
            <div class="row">
                <h3 id="ajuridico" runat="server">Expedientes a Revisar</h3>
                 <div id="divrevis" runat="server" class="col-md-12" style="overflow-x: auto; height:500px;" >
    ...
    AutoGenerateColumns="False" BorderStyle="Solid"  AllowPaging="true" PageSize="10" OnPageIndexChanging="DGVLEGALIZAR_PageIndexChanging" OnSelectedIndexChanged="DGVLEGALIZAR_SelectedIndexChanged" >
                    <Columns>
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Fecha/Hora Desembolso">
                           <ItemTemplate>
                           <asp:Label ID="lblfecha"  Width="150px" Text='<%# Eval("gen_fechadesembolso") %>' runat="server" />
        ...
        <HeaderStyle CssClass="prueba" Width="300px" ForeColor="White"></HeaderStyle>
                       ...
                       <input type="text" id="buscarb" runat="server" visible="false" placeholder="Busca por No. Crédito, Nombre, Monto o CIF" class="searchTerm"  /> 
                        <asp:GridView ID="DGVMESASIG" CssClass="table table-striped" style="width: 100%;text-align:center" runat="server"  HeaderStyle-BackColor="#003563" HeaderStyle-ForeColor="White"
    AutoGenerateColumns="False" BorderStyle="Solid" OnSelectedIndexChanged="DGVMESASIG_SelectedIndexChanged1"  AllowPaging="true" PageSize="2000" OnPageIndexChanging="DGVMESASIG_PageIndexChanging" >
                    <Columns>
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Fecha/Hora Desembolso">
                           <ItemTemplate>
                           <asp:Label ID="lblfecha"  Width="150px" Text='<%# Eval("gen_fechadesembolso") %>' runat="server" />
