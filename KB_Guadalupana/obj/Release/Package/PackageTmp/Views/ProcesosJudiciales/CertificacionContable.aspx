               ...
               <div class="formularioCobros">
                 ...
                 <div style="display:flex; justify-content:center">
                    ...
                    <div id="Div1" runat="server" class="encabezado" style="border-color:#8DDB51; border:2px #4B752B solid">
                        ...
                        <label class="titulos" style="margin-left:17%"><b>DPI</b></label>
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White"></HeaderStyle>
                ...
                <div class="encabezado">
                    ...
                    <input id="Año" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="Mes" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="Dia" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="AñoLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="MesLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="DiaLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                       <input id="Total" runat="server" onchange="total(this.value);" type="text" class="formatoinput" visible="false"/>
                      <input id="SaldoActualLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="InteresesLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="MontoOriginalLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                       <input id="SaldoDecimales" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="InteresesDecimales" runat="server" type="text" class="formatoinput" visible="false"/>
                     <input id="MontoDecimales" runat="server" type="text" class="formatoinput" visible="false"/>
                       <input id="TotalLetras" runat="server" type="text" class="formatoinput" visible="false"/>
                      <input id="TotalDecimales" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="idcertidicacion" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="Intereses2" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="MontoOriginalEspacios" runat="server" type="text" class="formatoinput" visible="false"/>
                     ...
                     <input id="InteresesEspacio" runat="server" type="text" class="formatoinput" visible="false"/>
                      <input id="IncendioEspacio" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="MoraEspacio" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="GastosEspacio" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="SeguroEspacio" runat="server" type="text" class="formatoinput" visible="false"/>
                    <input id="TotalEspacio" runat="server" type="text" class="formatoinput" visible="false"/>
                ...
                <div id="IntegracionC" runat="server" style="display:flex; justify-content:center" class="encabezado">
                  ...
                  <div class="formato2">
                   ...
                   <div id="validado" runat="server" class="encabezado">
                       ...
                       <div id="certificacion" runat="server" class="formato">
                            <label class="titulos">Certificación Contable</label>
                        ...
                        <div id="Razones" runat="server" class="formato3">
                            ...
                            <input id="RazonesRechazo" runat="server" type="text" class="formatoinput2" placeholder="Ingrese observaciones" maxlength="300" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
                        </div><br />
                   </div>
    ...
    function posicionarMenu() {
        ...
        <script>
            function total(numero) {
                ...
                document.getElementById('Total').innerHTML = formatter.format(numero);
            }
        </script>
         <script>
