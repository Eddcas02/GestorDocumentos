<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudChequeNotificacionApremio.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.SolicitudChequeNotificacionApremio" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                ...
                <div class="encabezado">
                    ...
                    <%--<label class="titulos" style="margin-bottom:10px"><b>Cheque </b></label><br />--%>
                ...
                <div class="formato2">
                        ...
                        <asp:Button ID="Rechazar" runat="server" CssClass="boton2" Text="Rechazar" OnClick="Rechazar_Click" Visible="false"/>
                    </div><br />
                ...
                <div class="formato2">
                    ...
                    <asp:Button ID="Enviar" runat="server" CssClass="boton2" Text="Enviar" OnClick="Enviar_Click" Visible="false"/>
                </div><br /><br />
