<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevaInvestigacion.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.NuevaInvestigacion" %>
                   ...
                   <div class="menu2" id="ventana" runat="server" style="overflow: auto; height: 450px">
                    ...
                    <div style="display:flex; justify-content:center">
                       ...
                       <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <div class="formato4" style="display:flex; justify-content:flex-start">
                                    <label class="titulos" style="display:flex;align-items:center;justify-content:flex-start; width:130px"><b>Honorarios</b></label>
                                    <label class="titulos" style="width:4%;margin-left:20px;display:flex;align-items:center"><b>Q</b></label>
