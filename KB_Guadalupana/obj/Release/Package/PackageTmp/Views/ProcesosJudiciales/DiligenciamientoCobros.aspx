    ...
    <form id="form1" runat="server">
        <div class="general">
            <div class="formularioCobros">
                ...
                <div id="BuscarInvestigacion" runat="server" class="formatoBuscar">
                    <input id="Buscar" runat="server" type="text" class="formatoinput4" placeholder="Buscar..." style="border:0.5px solid #DEDEDE"/>
                    <a class="fondoLupa">
                ...
                <br />
                      ...
                      <div id="Div2" runat="server" style="overflow: auto; height: 300px">
                        <asp:GridView ID="gridViewInvestigacion" runat="server" CssClass="tabla" AutoGenerateColumns="False" BackColor="White" ForeColor="Black"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedInvestigacion" BorderStyle="Solid">
                              <Columns>
                                ...
                                <asp:ButtonField   Text="Investigacion" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="Black">
                                    <ItemStyle Width="120px" ForeColor="Black"></ItemStyle>
                                </asp:ButtonField>
                            </Columns>
                ...
                <div id="BuscarVoluntaria" runat="server" class="formatoBuscar">
                    <input id="Buscar2" runat="server" type="text" class="formatoinput4" placeholder="Buscar..." style="border:0.5px solid #DEDEDE"/>
                    <a class="fondoLupa">
                        <img src="../../Imagenes/Imagenes_procesos/lupa.png" style="height:30px"/>
                    </a>
                </div>
                <br />
                     ...
                     <div id="Div1" runat="server" style="overflow: auto; height: 300px">
                        <asp:GridView ID="gridViewVoluntaria" runat="server" CssClass="tabla" AutoGenerateColumns="False" BackColor="White" ForeColor="Black"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedVoluntaria" BorderStyle="Solid">
                              <Columns>
                                ...
                                <asp:ButtonField   Text="Transaccion" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="Black">
                                    <ItemStyle Width="120px" ForeColor="Black"></ItemStyle>
                                </asp:ButtonField>
                            </Columns>
                             <HeaderStyle CssClass="prueba"  ForeColor="White" BackColor="#0069C4"></HeaderStyle>
