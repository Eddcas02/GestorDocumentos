<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevaInvestigacionCartera.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.NuevaInvestigacionCartera" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                   <div style="display:flex; justify-content:center">
                        <label style="font-size:18px" class="titulos">Investigación del asociado</label>
                    </div><br />
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White"></HeaderStyle>
                   ...
                   <div class="menu2" id="ventana" runat="server" style="overflow: auto; height: 450px">
                    ...
                    <div style="display:flex; justify-content:center">
                       ...
                       <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <div class="formato4" style="display:flex; justify-content:flex-start">
                                    <label class="titulos" style="display:flex;align-items:center;justify-content:flex-start; width:130px"><b><%# Eval("Nombre") %></b></label>
                                    <label class="titulos" style="width:4%;margin-left:20px;display:flex;align-items:center"><b>Q</b></label>
                                    <input id="MontoPago" style="width:32%;text-align:end" runat="server" type="text" class="formatoinput" value='<%# Eval("Monto") %>' maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" readOnly="readOnly"/>
                                </div><br />
                            </ItemTemplate>
                        </asp:Repeater>
                ...
                <div class="encabezado">
                    <label style="font-size:15px" class="titulos"><b>Documentación de soporte</b></label><br /><br />
                     ...
                     <div class="formato">
                       ...
                       <div style="justify-content: center;display:flex" class="formato">
                        ...
                        <input id="FechaEstadoCuenta" runat="server" type="date" class="formatoinput" readonly="readonly"/>
                    </div><br />--%>

                          <div class="formato3">
                                <span class="titulos"><b>Observaciones</b></span>
                                <input id="Observaciones2" runat="server" type="text" class="formatoinput2" placeholder="Ingrese Observaciones" maxlength="150" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                            </div><br />

                   <%-- <asp:Repeater ID="Repeater2" runat="server">
                        <ItemTemplate>
                         <div class="formatoTitulo" style="margin-bottom:5px">
                            <label class="titulos"><b>Número</b></label>
                            <label class="titulos" style="margin-left:47%"><b>Fecha</b></label>
                        </div>

                        <div class="formato">
                            <input id="Numero" runat="server" type="text" class="formatoinput" readonly="true" value="<%# Eval("Numero") %>" maxlength="11" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
                            <input id="Fecha" runat="server" type="text" class="formatoinput" readonly="true" value="<%# Eval("Fecha") %>"/>
                        </div><br />
                        </ItemTemplate>
                    </asp:Repeater>--%>
                    ...
                    <br /><br />
                        ...
                        <asp:DropDownList id="Resultado" runat="server" Width="100%" class="formatoinput2" AutoPostBack="true"></asp:DropDownList>
                    <br /><br />
                    </div>
                 ...
                 <div class="formato2">
                        <asp:Button ID="PCBoton" runat="server" CssClass="boton" Text="Enviar" OnClick="PCBoton_Click"/>
                    </div><br />
