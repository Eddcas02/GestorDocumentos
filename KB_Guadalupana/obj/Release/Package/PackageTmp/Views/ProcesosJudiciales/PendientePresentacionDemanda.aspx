    ...
    <form id="form1" runat="server">
        <div class="general">
            <div class="formularioCobros">
                ...
                <div id="Resolucion" runat="server">

                     <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Pendiente primera resolución</label>
                 </div><br />
                ...
                <br />
                    ...
                    <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewResolucion" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black" BackColor="White"
                            ...
                            <Columns>
                                ...
                                <asp:ButtonField   Text="Primera resolución" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="Black">
                                    <ItemStyle Width="100px"></ItemStyle>
                                </asp:ButtonField>
                            </Columns>
                             <HeaderStyle CssClass="prueba"  ForeColor="White" BackColor="#0069C4"></HeaderStyle>
        ...
        <script>
            $(document).ready(function () {
                $("#Buscar2").on("keyup", function () {
                    var value = $(this).val().toLowerCase();
                    $("#gridViewResolucion tr").filter(function () {
                        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                    });
                });
            });
