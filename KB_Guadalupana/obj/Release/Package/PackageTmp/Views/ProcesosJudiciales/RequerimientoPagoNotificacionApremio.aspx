<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequerimientoPagoNotificacionApremio.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.RequerimientoPagoNotificacionApremio" %>
                ...
                <div class="encabezado">
                   ...
                   <%-- <div id="DocCheque" runat="server">
                    ...
                    <div id="ObservacionesFactura" runat="server">
                        ...
                        <input id="RazonesRechazo" runat="server" type="text" class="formatoinput2" placeholder="Ingrese razones de rechazo (si es el caso)" maxlength="150" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
                        <br />
                    </div>
