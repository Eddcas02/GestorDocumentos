     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White"></HeaderStyle>
                ...
                <div class="encabezado">
                    ...
                    <div style="justify-content: center;display:flex" class="formato">
                        ...
                        <asp:GridView ID="gridViewDocumentos" runat="server" AutoGenerateColumns="False" CssClass="tabla" DataKeyNames="Codigo"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedDocumento" BorderStyle="Solid" OnRowDeleting="gridViewDocumentos_RowDeleting">
                             <Columns>
                    ...
                    <div style="display:flex; justify-content:center">
                        ...
                        <div class="formato4" style="display:flex; justify-content:flex-start">
                            <label class="titulos" style="display:flex;align-items:center;justify-content:flex-start; width:130px"><b>Intereses vencidos:</b></label>
                             <label class="titulos" style="width:4%;margin-left:20px;display:flex;align-items:center"><b>Q</b></label>
                            <input id="Interes1" style="width:32%;text-align:end" onkeyup="format(this)" onchange="format(this), intereses1(this.value);" runat="server" type="text" min="0" class="formatoinput" value="0" placeholder="Intereses" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div><br />

                         <div class="formato4" style="display:flex; justify-content:flex-start">
                            <label class="titulos" style="display:flex;align-items:center;justify-content:flex-start; width:130px"><b>Mora:</b></label>
                             <label class="titulos" style="width:4%;margin-left:20px;display:flex;align-items:center"><b>Q</b></label>
                             <input id="Mora" style="width:32%;text-align:end" onkeyup="format(this)" onchange="format(this), mora1(this.value);" runat="server" type="text" min="0" class="formatoinput" value="0" placeholder="Mora" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div><br />
