    ...
    <form id="form1" runat="server">
         <div class="general">
            <div class="formularioCobros">
                ...
                <div id="BuscarDevueltos" runat="server" class="formatoBuscar">
                ...
                <div id="tablaC" runat="server" style="overflow: auto; height: 300px">
                        <asp:GridView ID="gridViewCreditos" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black" BackColor="White"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Días">
                                    <ItemTemplate>
                                       <asp:Label ID="lbldias" Text='<%# Eval("Dias") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <div id="creditosEnviados" runat="server">
                    <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Créditos enviados</label>
                 </div><br />

                    <div class="formatoBuscar">
                    <input id="Buscar3" runat="server" type="text" class="formatoinput4" placeholder="Buscar..." style="border:0.5px solid #DEDEDE"/>
                    <a class="fondoLupa">
                        <img src="../../Imagenes/Imagenes_procesos/lupa.png" style="height:30px"/>
                    </a>
                </div>
                <br />
                    ...
                    <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewEnviados" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedEnviados" BorderStyle="Solid">
                            <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="No. de crédito">
                                    <ItemTemplate>
                                       <asp:Label ID="lblnumcredito" Text='<%# Eval("Credito") %>' runat="server" />
                                ...
                                <asp:ButtonField   Text="Asignar/Desasignar" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="Black">
                                    <ItemStyle Width="100px" ForeColor="Black"></ItemStyle>
                                </asp:ButtonField>
                            </Columns>
                             <HeaderStyle CssClass="prueba"  ForeColor="White" BackColor="#0069C4"></HeaderStyle>
        ...
        <script>
            $(document).ready(function () {
                $("#Buscar2").on("keyup", function () {
                    var value = $(this).val().toLowerCase();
                    $("#gridViewCertificacion tr").filter(function () {
                        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                    });
                });
            });
        ...
        <script>
            $(document).ready(function () {
                $("#Buscar3").on("keyup", function () {
                    var value = $(this).val().toLowerCase();
                    $("#gridViewEnviados tr").filter(function () {
                        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                    });
                });
            });
