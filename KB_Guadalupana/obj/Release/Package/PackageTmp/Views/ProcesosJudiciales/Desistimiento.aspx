<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Desistimiento.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.Desistimiento" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                 <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Desistimiento</label>
                 </div><br />
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White"></HeaderStyle>
                ...
                <div class="encabezado">
                    <label class="titulos"><b>Memorial de desistimiento</b></label><br />
                        <div class="formato">
                            <asp:DropDownList id="MemorialDesistimiento" runat="server" class="formatoinput3" AutoPostBack="false"></asp:DropDownList>
                    ...
                    <div style="justify-content: center;display:flex" class="formato">
                        ...
                        <asp:GridView ID="gridViewDesistimiento" runat="server" AutoGenerateColumns="False" CssClass="tabla"
                    ...
                    <div class="formato3">
                            <span class="titulos"><b>Fecha de presentación del desistimiento</b></span>
                            <input id="FechaDesistimiento" runat="server" type="date" class="formatoinput2" />
                        </div><br /><br />


                    <label class="titulos"><b>Resolución del memorial de desistimiento</b></label><br />
                        <div class="formato">
                            <asp:DropDownList id="ResolucionMemorial" runat="server" class="formatoinput3" AutoPostBack="false"></asp:DropDownList>
                    ...
                    <div class="formato3">
                        <span class="titulos"><b>Fecha resolución del desistimiento</b></span>
                        <input id="FechaResolucion" runat="server" type="date" class="formatoinput2" />
                    </div><br /><br /><br />

                    <div>

                      <label class="titulos" style="margin-bottom:10px"><b>Facturación</b></label><br />
                    ...
                    <div class="formatoTitulo" style="margin-bottom:5px">
                     ...
                     <input id="Otro" runat="server" type="text" min="0" class="formatoinput2" placeholder="Ingrese otro motivo" visible="false" maxlength="11" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/><br />
