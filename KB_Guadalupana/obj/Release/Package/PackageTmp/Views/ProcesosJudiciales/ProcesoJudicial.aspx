...
<body>
    <form id="form1" runat="server">
            ...
            <div class="formularioCobros">
               ...
               <div id="Div1" runat="server" class="encabezado" style="border-color:#8DDB51; border:2px #4B752B solid">
                    ...
                    <div class="formatoTitulo" style="margin-bottom:5px">
                        ...
                        <label class="titulos" style="margin-left:30%"><b>DPI</b></label>
     ...
     <asp:GridView ID="gridview1" CssClass="container"  style="width: 692px;  text-align:center" runat="server"  HeaderStyle-ForeColor="White"
                   ...
                   <div class="menu2" id="ventana" runat="server">
                    ...
                    <div class="formato3">
                     ...
                     <div class="formato3">
                        ...
                        <input id="NumeroIncidente" runat="server" type="text" class="formatoinput5" min="0" placeholder="No. incidente" maxlength="11" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" readOnly="readOnly" visible="false"/>
                    </div><br />
                    ...
                    <div style="display:flex; justify-content:center">
                        ...
                        <div class="formato4" style="display:flex; justify-content:flex-start">
                            <label class="titulos" style="display:flex;align-items:center;justify-content:flex-start; width:130px"><b>Intereses vencidos:</b></label>
                             <label class="titulos" style="width:4%;margin-left:20px;display:flex;align-items:center"><b>Q</b></label>
                            <input id="Interes1" style="width:32%;text-align:end" onkeyup="format(this)" onchange="format(this), intereses1(this.value);" runat="server" type="text" min="0" class="formatoinput" value="0" maxlength="12" placeholder="Intereses" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div><br />

                         <div class="formato4" style="display:flex; justify-content:flex-start">
                            <label class="titulos" style="display:flex;align-items:center;justify-content:flex-start; width:130px"><b>Mora:</b></label>
                             <label class="titulos" style="width:4%;margin-left:20px;display:flex;align-items:center"><b>Q</b></label>
                              <input id="Mora" style="width:32%;text-align:end" onkeyup="format(this)" onchange="format(this), mora1(this.value);" runat="server" type="text" min="0" class="formatoinput" placeholder="Mora" value="0" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div><br />
