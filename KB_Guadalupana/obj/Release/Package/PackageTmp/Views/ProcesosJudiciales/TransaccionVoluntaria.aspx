<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransaccionVoluntaria.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.TransaccionVoluntaria" %>
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
  ...
  <div id="formulario" runat="server" class="encabezado">
                ...
                <div class="encabezado">
                    <label style="font-size:15px" class="titulos"><b>Transacción voluntaria</b></label><br /><br />

                    <div class="formato3" id="EsVoluntaria" runat="server">
                        <label class="titulos"><b>¿La transacción es voluntaria?</b></label>
                        <asp:DropDownList id="Voluntaria" runat="server" Width="100%" class="formatoinput2"></asp:DropDownList>
                    </div><br /><br />
