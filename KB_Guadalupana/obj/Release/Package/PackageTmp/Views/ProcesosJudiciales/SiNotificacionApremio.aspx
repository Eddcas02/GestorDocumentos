<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiNotificacionApremio.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.SiNotificacionApremio" %>
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White"></HeaderStyle>
                ...
                <div class="encabezado">
                    ...
                    <div id="notificacion" runat="server" visible="false">
                ...
                <div class="formato2">
                    <asp:Button ID="Guardar" runat="server" CssClass="boton" Text="Enviar Solicitud" Visible="false" OnClick="Guardar_Click" />
                  </div><br />
