                     ...
                     <div id="SiResultados" runat="server">
                      ...
                      <div style="justify-content: center;display:flex" class="formato">
                        ...
                        <asp:GridView ID="gridViewDocumentacion" runat="server" AutoGenerateColumns="False" CssClass="tabla"
                         ...
                         <label class="titulos"><b>Documentos nueva investigación</b></label><br />

                         <div style="justify-content: center;display:flex" class="formato">
                        <div style="overflow: auto; height: 150px">
                        <asp:GridView ID="gridViewInvestigacion" runat="server" AutoGenerateColumns="False" CssClass="tabla"
                         ...
                         <label class="titulos"><b>Memorial de solicitud de medidas precautorias</b></label><br />
                        <div class="formato">
                          ...
                          <div style="justify-content: center;display:flex" class="formato">
                        <div style="overflow: auto; height: 150px">
                        <asp:GridView ID="gridViewMemorialsolicitud" runat="server" AutoGenerateColumns="False" CssClass="tabla"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedMemorialsolicitud" BorderStyle="Solid">
                             <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño" Visible="false" HeaderText="No. documento">
                                    <ItemTemplate>
                                       <asp:Label ID="lblid" Text='<%# Eval("Codigo") %>' runat="server" />
                         ...
                         <div class="formato3" >
                            <label class="titulos"><b>Fecha de presentación al juzgado</b></label>
                            <input id="FechaJuzgado" runat="server" type="date" class="formatoinput2" />
                        </div><br />
