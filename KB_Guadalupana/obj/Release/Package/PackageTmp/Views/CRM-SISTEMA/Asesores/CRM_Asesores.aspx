...
<body>
    ...
    AutoGenerateColumns="False" OnSelectedIndexChanged = "OnSelectedIndexChangedprospectos" BorderStyle="Solid" Width="90%" >
                 ...
                 <asp:TemplateField HeaderText="Contactado por"  Visible="false">
                         ...
                         <asp:TemplateField HeaderText="Semáforo"  Visible="true">
                           <ItemTemplate>
                            <asp:Label ID="lblsemaforo" Text='<%# Eval("crmsemaforo_estadonombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                         <asp:TemplateField HeaderText="Estado"  Visible="true">
                           <ItemTemplate>
                            <asp:Label ID="lblestado" Text='<%# Eval("crmestado_descripcionnombre") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
