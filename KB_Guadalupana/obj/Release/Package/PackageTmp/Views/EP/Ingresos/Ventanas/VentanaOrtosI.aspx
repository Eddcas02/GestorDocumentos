<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VentanaOrtosI.aspx.cs" Inherits="KB_Guadalupana.Views.EP.Ventanas.VentanaOrtosI" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="input-group mb-3">
                     <div class="col-lg-4">
                      <label  id="encabasignados" runat="server" >Entidad</label>
                         ...
                         <asp:DropDownList ID="TipoOtroIngresoID" AutoPostBack="false"  runat="server" style="min-width:80%"  Width="100%">
                       
                         </asp:DropDownList>
       
                          </div>
                    <script>
                        $('#<%=TipoOtroIngresoID.ClientID%>').chosen();
                    </script>

                        
                  <div class="col-lg-2">
                        <label>Descripción</label>
                         <asp:TextBox runat="server" CssClass="form-control" ID="ColaboradoringresoOtrDescripci" TextMode="SingleLine" Width="100%" />
                  ...
                  <div class="col-lg-2">
                   ...
                   <asp:TextBox CssClass="form-control" style="color:black" placeholder="0.00" 
                        type="text" name="email" id="ColaboradoringresoOtrValor" onkeyup="format(this)"
     ...
     <script>
        function format(input) {
         ...
         var texto1 = document.querySelector('#ColaboradoringresoOtrValor');
