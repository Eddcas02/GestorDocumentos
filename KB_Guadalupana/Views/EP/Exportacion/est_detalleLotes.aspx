<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="est_detalleLotes.aspx.cs" Inherits="KB_Guadalupana.Views.EP.est_detalleLotes" %>
                ...
                <div class="col-4 ">
                    ...
                    <div class="container-fluid">
                          <div class="col-lg-2" style="text-align: center">
                                                      <asp:Label ID="lblsuccess" Text="Usuarios asignados" runat="server" Visible="false" ForeColor="Green" />    
                               ...
                               <asp:Label ID="lblusuarios" Text="" runat="server" Visible="false" ForeColor="Red" />  
                                            ...
                                            <br />
                                            <asp:Button ID="AsignarLote" Font-Names=" 'Rubik', sans-serif" runat="server"
                                                Width="80%" Height="40px" CssClass="btn1" OnClientClick="return confirm('¿Seguro que desea asignar estos usuarios?')" CausesValidation="False"
                                                Text="Asignar Al Lote" OnClick="AsignarLote_Click" />
