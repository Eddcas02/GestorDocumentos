<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VentanaContingente.aspx.cs" Inherits="KB_Guadalupana.Views.EP.Ventanas.VentanaContingente" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="row">
                <div class="col-12 text-center ">
                    <h2>Pasivo Contingente (Codeudor o Fiador)</h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 ">
                <div class="input-group mb-3">
                    ...
                    <div class="col-lg-4">
                     ...
                     <div class="col-lg-2">
                        <label>Nombre de Deudor</label>
                         <asp:TextBox runat="server" CssClass="form-control" ID="ColaboradorPasivoContDeudor" TextMode="SingleLine" Width="100%" />
                    
      
                     </div>
                      <div class="col-lg-2">
                        <label>Relación con Deudor</label>
                         <asp:TextBox runat="server" CssClass="form-control" ID="ColaboradorPasivoContRelacion" TextMode="SingleLine" Width="100%" />
                    ...
                    <div class="col-lg-2">
                      <label  id="Label2" runat="server" >Saldo en Quetzales</label>
             <asp:TextBox CssClass="form-control" style="color:black" placeholder="0.00" 
                        type="text" name="email" id="ColaboradorPasivoContSaldo" onkeyup="format(this)"
                  ...
                  <div class="col-lg-2">
                    ...
                    <asp:TextBox runat="server" ID="ColaboradorPasivoContFechaDese"  CssClass="form-control" TextMode="Date" Width="100%" AutoPostBack="true" OnTextChanged="ColaboradorPasivoContFechaDese_TextChanged" />
             ...
             <div class="col-lg-2">
                    ...
                    <asp:TextBox runat="server" ID="ColaboradorPasivoContFechaFin"  CssClass="form-control" TextMode="Date" Width="100%" />
     ...
     <script>
        function format(input) {
         ...
         var texto1 = document.querySelector('#ColaboradorPasivoContSaldo');
