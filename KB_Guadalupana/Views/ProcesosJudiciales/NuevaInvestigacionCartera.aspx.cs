...
{
    public partial class NuevaInvestigacionCartera : System.Web.UI.Page
    {
        ...
        public void llenarformulario()
        {
            ...
            if (var1.Length == 4)
            {
                String script = "alert('Se perdió la conexión, intente más tarde'); window.location.href= 'DiligenciamientoCobros.aspx';";
        ...
        //{
        //    DataSet contador = new DataSet();
        //    string numcredito = Session["credito"] as string;
        //    contador = sn.consultarcontador(numcredito);
        //    Repeater2.DataSource = contador;
        //    Repeater2.DataBind();
        //}
        ...
        protected void PCBoton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.insertarbitacora(sig5, NumIncidente.Value, numcredito, NombreCliente.Value, "Recibido", "51", "26", fechahoraactual, fechacreacion2, Observaciones2.Value);
                ...
                {
                    sn.cambiarestadoinvestigacion3(numcredito, "9");
                    string sig3 = sn.siguiente("pj_bitacora", "idpj_bitacora");
                    sn.insertarbitacora(sig3, NumIncidente.Value, numcredito, NombreCliente.Value, "Nueva Investigacion", "26", "51", fechahoraactual, fechacreacion2, Observaciones2.Value);
                }
                else
                {
                    string sig3 = sn.siguiente("pj_bitacora", "idpj_bitacora");
                    sn.insertarbitacora(sig3, NumIncidente.Value, numcredito, NombreCliente.Value, "Investigacion sin resultados", "26", "26", fechahoraactual, fechacreacion2, Observaciones2.Value);
                }
