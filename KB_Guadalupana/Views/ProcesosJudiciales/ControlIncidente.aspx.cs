    ...
    public partial class ControlIncidente : System.Web.UI.Page
    {
        ...
        public void llenarbitacoraascendente()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT DISTINCT(idpj_incidente), pj_numcredito, pj_nombre, pj_fechacreacion, DATEDIFF(now(), pj_fechacreacion) AS Dias FROM pj_bitacora ORDER BY pj_fechacreacion ASC";
                    MySqlDataAdapter myCommand = new MySqlDataAdapter(query, sqlCon);
                    DataTable dt = new DataTable();
                    myCommand.Fill(dt);
                    gridViewIncidente.DataSource = dt;
        ...
        public void llenarbitacoradescendente()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT DISTINCT(idpj_incidente), pj_numcredito, pj_nombre, pj_fechacreacion, DATEDIFF(now(), pj_fechacreacion) AS Dias FROM pj_bitacora ORDER BY pj_fechacreacion DESC";
                    MySqlDataAdapter myCommand = new MySqlDataAdapter(query, sqlCon);
                    DataTable dt = new DataTable();
                    myCommand.Fill(dt);
                    gridViewIncidente.DataSource = dt;
        ...
        public void llenarbitacoracondicion(string condicion)
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    //string query = "SELECT idpj_incidente, pj_numcredito, pj_nombre, pj_fechacreacion, DATEDIFF(now(), pj_fechacreacion) AS Dias FROM pj_bitacora "+condicion+" GROUP BY pj_numcredito ORDER BY pj_fechacreacion ASC";
