<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendienteNotificacionApremio.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.PendienteNotificacionApremio" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                ...
                <div id="SiNotificacion" runat="server">
                    <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Si notificación al asociado (Ejecutivo en la vía de apremio)</label>
                 </div><br />
                ...
                <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewSiNotificacion" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black" BackColor="White"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedSiNotificacion" BorderStyle="Solid" >
                            <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="No. de crédito">
                                    <ItemTemplate>
                                       <asp:Label ID="lblnumcredito" Text='<%# Eval("Credito") %>' runat="server" />
                ...
                <div id="NotificacionHonorarios" runat="server">
                    <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Notificación al asociado (Ejecutivo en la vía de apremio)</label>
                 </div><br />
                ...
                <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewHonorarios" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedHonorarios" BorderStyle="Solid" >
                            <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="No. de crédito">
                                    <ItemTemplate>
                                       <asp:Label ID="lblnumcredito" Text='<%# Eval("Credito") %>' runat="server" />
                ...
                <div id="NotificacionApremio2" runat="server">
                    <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Notificación al asociado (Ejecutivo en la vía de apremio)</label>
                 </div><br />
                ...
                <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewApremio" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black" BackColor="White"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedApremio" BorderStyle="Solid" >
                            <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="No. de crédito">
                                    <ItemTemplate>
                                       <asp:Label ID="lblnumcredito" Text='<%# Eval("Credito") %>' runat="server" />
        ...
        <script>
            $(document).ready(function () {
                $("#Buscar2").on("keyup", function () {
                    var value = $(this).val().toLowerCase();
                    $("#gridViewSiNotificacion tr").filter(function () {
                        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                    });
                });
            });
