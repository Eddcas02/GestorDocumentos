    ...
    public partial class Desistimiento : System.Web.UI.Page
    {
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.guardaretapa(sig11, "34", numcredito, sn.datetime(), "Enviado", idusuario, "51", NombreCliente.Value, NumIncidente.Value);
                sn.cambiarestado(numcredito, "32");

                string sig6 = sn.siguiente("pj_facturacionabogado", "idpj_facturacionabogado");
                ...
                sn.guardarfacturaabogado(sig6, numcredito, idusuario, NumFactura.Value, Serie.Value, Descripcion.Value, ImporteTotal.Value, FechaEmision.Value, ImporteCaso.Value, MotivoPago.SelectedValue, Otro.Value, NumCif.Value, ClienteNombre.Value, NombreCheque.Value, Observaciones.Value, "Iniciado", "34");
