...
{
    public partial class RequerimientoPagoDesistimiento : System.Web.UI.Page
    {
        ...
        public void GenerarPDF()
        {
            ...
            try
            {
                ...
                dt1 = sn.solicitudchequeEstapa6(Serie.Value);
        ...
        public void llenarinputs()
        {
            ...
            string numcredito = Session["credito"] as string;
            string importetotal = sn.importetotal6(numcredito);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            string cheque = sn.tipodocumentoCheque3(numcredito);
            ...
            else
            {
                ...
                sn.insertarrequerimientopago(sig, numcredito, idusuario, Observaciones.Value, Concepto.Value, NombreCuenta.Value, NumCuenta.Value, CentroCosto.Value, ObservacionesCredito.Value, "35");

                DataTable dt1 = new DataTable();

                
                dt1 = sn.solicitudcheque2Etapa6(Serie.Value);
                ...
                for (int i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    sn.cambiarestado(credito2, "34");

                    string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                    sn.guardaretapa(sig2, "35", credito2, sn.datetime(), "Enviado", idusuario, "34", nombre2, incidente);
        ...
        public void llenarcombodocumento()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT * FROM pj_tipodocumento  WHERE idpj_tipodocumento IN (59,60)";
                    MySqlDataAdapter myCommand = new MySqlDataAdapter(query, sqlCon);
                    DataSet ds = new DataSet();
                    myCommand.Fill(ds);
        ...
        protected void GuardarVoucher_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.cambiarestado(numcredito, "36");
                string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
        ...
        protected void Validar_Click(object sender, EventArgs e)
        {
            ...
            sn.cambiarestadocredito(numcredito, "34");
            sn.cambiarestadoFactura6(numcredito);
        ...
        protected void Rechazar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.estadodevuelto(numcredito, "34", "34");
