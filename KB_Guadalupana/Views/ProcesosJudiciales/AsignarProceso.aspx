            ...
            <div class="formularioCobros">
                <div class="encabezado">
                         <div class="formatoTitulo" style="margin-bottom:5px">
                            ...
                            <label class="titulos" style="margin-left:44%"><b>CIF</b></label>
                        </div>
                     ...
                     <div class="formato">
                       ...
                       <div class="formatoTitulo" style="margin-bottom:5px">
                            ...
                            <label class="titulos" style="margin-left:43%"><b>Segundo Nombre</b></label>
                        </div>
                    ...
                    <div class="formato">
                        ...
                        <div class="formatoTitulo" style="margin-bottom:5px">
                            ...
                            <label class="titulos" style="margin-left:43%"><b>Segundo Apellido</b></label>
                        </div>
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White" BackColor="#0069C4"></HeaderStyle>
                ...
                <div id="Busqueda1" runat="server" class="formatoBuscar">
                ...
                <div id="tablaC" runat="server" style="overflow: auto; height: 300px">
                        <asp:GridView ID="gridViewCreditos" runat="server" CssClass="tabla" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:ButtonField   Text="Ver crédito" FooterStyle-ForeColor="White" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="White">
                                    <ItemStyle Width="100px" ForeColor="White"></ItemStyle>
                                </asp:ButtonField>
                            </Columns>
                             <HeaderStyle CssClass="prueba"  ForeColor="White" BackColor="#0069C4"></HeaderStyle>
                        </asp:GridView>
                 ...
                 <div style="display:flex; justify-content:center">
                        <span id="EditarCreditos" runat="server" style="font-size:18px" class="titulos">Editar créditos enviados</span>
                    </div><br />
                ...
                <div id="Div1" runat="server" style="overflow: auto; height: 300px">
                        <asp:GridView ID="gridViewEditar" runat="server" CssClass="tabla" AutoGenerateColumns="False"
                            OnSelectedIndexChanged = "OnSelectedIndexChangedCreditosEditados" BorderStyle="Solid">
                              <Columns>
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="No. de crédito">
                                    <ItemTemplate>
                                       <asp:Label ID="lblnumcredito" Text='<%# Eval("Credito") %>' runat="server" />
                                ...
                                <asp:ButtonField   Text="Editar crédito" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="White">
                                    <ItemStyle Width="120px" ForeColor="White"></ItemStyle>
                                </asp:ButtonField>
                            </Columns>
                             <HeaderStyle CssClass="prueba"  ForeColor="White" BackColor="#0069C4"></HeaderStyle>
                 ...
                 <%--   <div style="display:flex; justify-content:center">
                        <span id="SolicitudIvestigacion" runat="server" style="font-size:18px" class="titulos">Solicitud de investigación</span>
                    </div><br />
        ...
        <script>
            $(document).ready(function () {
                $("#Buscar2").on("keyup", function () {
                    var value = $(this).val().toLowerCase();
                    $("#gridViewEditar tr").filter(function () {
                        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                    });
                });
            });
