...
{
    public partial class RequerimientoPagoNotificacionApremio : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string estado = Session["NombreEtapa"] as string;

                if (estado == "Cargar Voucher")
                {
                    llenarcomentarios();
                    llenarformulario();
                    llenarcomboformato();
        ...
        public void llenarcombodocumento()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT * FROM pj_tipodocumento  WHERE idpj_tipodocumento IN (74,75)";
        ...
        protected void Validar_Click(object sender, EventArgs e)
        {
            ...
            sn.cambiarestadocredito(numcredito, "40");
            sn.cambiarestadoFactura8(numcredito);
        ...
        protected void Rechazar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.estadodevuelto(numcredito, "34", "40");
        ...
        public void GenerarPDF()
        {
            ...
            try
            {
                ...
                dt1 = sn.solicitudchequeEstapa8(Serie.Value);
        ...
        public void llenarinputs()
        {
            ...
            string numcredito = Session["credito"] as string;
            string importetotal = sn.importetotal8(numcredito);
        ...
        public void datosfactura()
        {
            string numcredito = Session["credito"] as string;
            string estado = Session["etapa"] as string;
            string nombreestado = Session["NombreEtapa"] as string;

            string[] factura;

            if (nombreestado == "Cargar Voucher")
            {
                factura = sn.datosfactura8(numcredito);
            }
            else
            {
                factura = sn.datosfactura88(numcredito);
            }
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.insertarrequerimientopago(sig, numcredito, idusuario, Observaciones.Value, Concepto.Value, NombreCuenta.Value, NumCuenta.Value, CentroCosto.Value, ObservacionesCredito.Value, "41");

                DataTable dt1 = new DataTable();


                dt1 = sn.solicitudcheque2Etapa8(Serie.Value);
                ...
                for (int i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    sn.cambiarestado(credito2, "40");

                    string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                    sn.guardaretapa(sig2, "41", credito2, sn.datetime(), "Enviado", idusuario, "34", nombre2, incidente);
        ...
        {
            string numcredito = Session["credito"] as string;
            string voucher = sn.tipodocumentoVoucher8(numcredito);
            string cheque = sn.tipodocumentoCheque8(numcredito);
            string estado = Session["etapa"] as string;
            ...
            else
            {
                ...
                sn.cambiarestado(numcredito, "42");
                string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                sn.guardaretapa(sig2, "43", numcredito, sn.datetime(), "Enviado", idusuario, "34", NombreCliente.Value, NumeroIncidente.Value);
