    ...
    public partial class PresentacionDemanda : System.Web.UI.Page
    {
        ...
        public void llenarcombodocumento()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT * FROM pj_tipodocumento  WHERE idpj_tipodocumento IN (16,71)";
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (tipoproceso != "3")
                    {
                        string sig6 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                        sn.guardaretapa(sig6, "15", numcredito, sn.datetime(), "Enviado", idusuario, "51", NombreCliente.Value, NumIncidente.Value);
                    }
                }
