...
{
    public partial class RequerimientoPagoApremio : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    voucher2 = sn.etapavoucher4(numcredito);
                }
        ...
        public void GenerarPDF()
        {
            ...
            try
            {
                ...
                {
                    dt1 = sn.solicitudchequeEstapa4(Serie.Value);
                }
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            string estado = Session["etapa"] as string;
            string numcredito = Session["credito"] as string;
            string cheque = sn.tipodocumentoCheque2(numcredito);
            ObservacionesFactura.Visible = false;
            Rechazar.Visible = false;
            ...
            else
            {
                ...
                {
                    dt1 = sn.solicitudcheque2Etapa4(Serie.Value);
                    string sig = sn.siguiente("pj_requerimientopago", "idpj_requerimientopago");
                    sn.insertarrequerimientopago(sig, numcredito, idusuario, Observaciones.Value, Concepto.Value, NombreCuenta.Value, NumCuenta.Value, CentroCosto.Value, ObservacionesCredito.Value, "28");
                }
                ...
                for (int i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    {
                        sn.cambiarestado(credito2, "27");

                        string tipoproceso = sn.obtenertipoproceso(numcredito);

                        string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                        sn.guardaretapa(sig2, "28", credito2, sn.datetime(), "Enviado", idusuario, "34", nombre2, incidente);
        ...
        public void llenarcombodocumento()
        {
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string query = "SELECT * FROM pj_tipodocumento  WHERE idpj_tipodocumento IN (69,51)";
                    MySqlDataAdapter myCommand = new MySqlDataAdapter(query, sqlCon);
                    DataSet ds = new DataSet();
                    myCommand.Fill(ds);
        ...
        protected void GuardarVoucher_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string tipoproceso = sn.obtenertipoproceso(numcredito);
                    sn.cambiarestado(numcredito, "29");
                    string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");

                    sn.guardaretapa(sig2, "30", numcredito, sn.datetime(), "Enviado", idusuario, "34", NombreCliente.Value, NumeroIncidente.Value);
        ...
        protected void Validar_Click(object sender, EventArgs e)
        {
            ...
            {
                sn.cambiarestadocredito(numcredito, "27");
                sn.cambiarestadoFactura5(numcredito);
            }
        ...
        protected void Rechazar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sn.estadodevuelto(numcredito, "34", "27");
                }
        ...
        //        {
        //            sqlCon.Open();
        //            string query = "SELECT * FROM pj_tipodocumento  WHERE idpj_tipodocumento = 51";
        //            MySqlDataAdapter myCommand = new MySqlDataAdapter(query, sqlCon);
        //            DataSet ds = new DataSet();
        //            myCommand.Fill(ds);
