<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendienteResolucionFavorable.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.PendienteResolucionFavorable" %>
...
<link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600&display=swap" rel="stylesheet"/>
    <title>Pendiente Resolución</title>
          <style>
    ...
    <form id="form1" runat="server">
        <div class="general">
            <div class="formularioCobros">
                    ...
                    <label style="font-size:18px" class="titulos">Pendiente gestión para entrega de fondos</label>
                 </div><br />
                ...
                <br />
                        ...
                        <asp:GridView ID="gridViewCreditos" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black"
                            ...
                            <Columns>
                                ...
                                <asp:ButtonField   Text="Gestión" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="Black">
