...
{
    public partial class SolicitudChequeApremio : System.Web.UI.Page
    {
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sn.cambiarestado(numcredito, "28");

                    string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                    sn.guardaretapa(sig2, "29", numcredito, sn.datetime(), "Cargar Voucher", idusuario, "28", nombrecliente2, NumeroIncidente.Value);

                    string sig = sn.siguiente("pj_solicitudcheque", "idpj_solicitudcheque");
                    sn.insertarsolicitudcheque(sig, numcredito, idusuario, NumCheque.Value, FechaEmision.Value, Banco.SelectedValue, ObservacionesCredito.Value, Monto.Value, "23");
                }
        ...
        protected void Enviar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sn.estadodevuelto(numcredito, "28", "22");
                }
