...
namespace KB_Guadalupana.Views.ProcesosJudiciales
{
    public partial class PendientePagoExtrajudicial : System.Web.UI.Page
    {
        ...
        protected void IrPago_Click(object sender, EventArgs e)
        {
            ...
            string obtenercreditos = sn.obtenercredito(credito);

            if(obtenercreditos == "" || obtenercreditos == null)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "error", "alert('El crédito no pertenece a un proceso');", true);
            }
            else if (desistimiento == "" || desistimiento == null)
            {
