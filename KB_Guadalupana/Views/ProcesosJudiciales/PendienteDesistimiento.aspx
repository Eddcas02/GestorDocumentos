<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendienteDesistimiento.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.PendienteDesistimiento" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Pendiente desistimiento</label>
                 </div><br />
                ...
                <div style="overflow: auto; height: 400px">
                        <asp:GridView ID="gridViewCreditos" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black" BackColor="White"
                            ...
                            <Columns>
                                ...
                                <asp:ButtonField   Text="Emitir desistimiento" ItemStyle-CssClass="celda fas fa-angle-double-right" CommandName="Select" ItemStyle-Width="90px" ControlStyle-ForeColor="Black">
