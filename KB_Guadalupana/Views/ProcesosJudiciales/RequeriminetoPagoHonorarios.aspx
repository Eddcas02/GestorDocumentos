<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequeriminetoPagoHonorarios.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.RequeriminetoPagoHonorarios" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                  ...
                  <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Requerimiento de pago</label>
                 </div><br />
                ...
                <div class="encabezado">
                    ...
                    <%--<div id="DocCheque" runat="server">
                        <label class="titulos"><b>Documentos</b></label><br /><br />

                        <div class="formato" id="suircheque" runat="server">
                    ...
                    <div style="width:20%">
                             ...
                             <asp:Button ID="VerDocumentos" runat="server" Width="100%" Height="25px" CssClass="boton3" Text="Ver Documentación" />

                             <cc1:ModalPopupExtender ID="mp1" runat="server" PopupControlID="Panl1" TargetControlID="VerDocumentos"
                    ...
                    <div class="formatoTitulo" style="margin-bottom:5px">
                        ...
                        <label class="titulos" style="margin-left:48%"><b>Nombre a quién se emite el cheque</b></label>
                    </div>
                     <div class="formato">
                        Q<input id="ImporteTotal2" runat="server" type="text" class="formatoinput" min="0" onkeyup="format(this)" onchange="format(this);" placeholder="Ingrese monto" maxlength="11" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        <input id="NombreCheque" runat="server" type="text" class="formatoinput" placeholder="Ingrese nombre" onkeypress="return sololetras(event);" maxlength="60" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                    </div><br />
                    ...
                    <%--<div id="ObservacionesFactura" runat="server">
                    ...
                    <div class="formato2">
                        ...
                        <asp:Button ID="Rechazar" runat="server" CssClass="boton" Text="Rechazar" OnClick="Rechazar_Click"/>
                    </div><br />--%>
                    ...
                    <div class="formato3">
                        <label class="titulos"><b>Seleccione formato a generar</b></label>
                        <asp:DropDownList id="Formato" runat="server" Width="100%" class="formatoinput2" AutoPostBack="true" OnSelectedIndexChanged="Formato_SelectedIndexChanged1"></asp:DropDownList>
                    </div><br />
                    
                        <div id="ObservacionesFormato" runat="server" visible="false">
                            <label class="titulos"><b>Observaciones </b></label>
                            <input id="Observaciones" runat="server" type="text" class="formatoinput2" placeholder="Ingrese observaciones" maxlength="200" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                            <br />
                        </div>
                        
                       <div id="ConceptoFormato" runat="server" visible="false">
                            <label class="titulos"><b>Concepto</b></label>     
                            <textarea id="Concepto" runat="server" type="text" style="max-height:60px;min-height:60px;" class="formatoinput2" placeholder="Ingrese concepto" maxlength="600" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"></textarea>
                            <br /><br />
                       </div>


                        <div class="formatoTitulo" style="margin-bottom:5px" id="Titulos" runat="server" visible="false">
                            <label class="titulos"><b>Nombre de la cuenta</b></label>
                            <label class="titulos" style="margin-left:15%"><b>No. de cuenta</b></label>
                            <label class="titulos" style="margin-left:22%"><b>Centro de costo</b></label>
                        </div>

                        <div class="formato" id="Campos" runat="server" visible="false">
                        ...
                        <div id="registro" runat="server" visible="false">
                            <label class="titulos"><b>Registro contable</b></label>
                            <input id="RegistroContable" runat="server" type="text" class="formatoinput2" placeholder="Ingrese observaciones" maxlength="50" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div>
                  ...
                  <div class="encabezado" id="voucher" runat="server">
                       <label class="titulos"><b>Documentos</b></label>
                        <div class="formato">
