<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DevueltosFactura.aspx.cs" Inherits="KB_Guadalupana.Views.ProcesosJudiciales.DevueltosFactura" %>
        ...
        <div class="general">
            <div class="formularioCobros">
                <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos">Modificar datos</label>
                   </div><br />
...
<ControlStyle CssClass="dise&#241;o"></ControlStyle>
     ...
     <HeaderStyle CssClass="prueba"  ForeColor="White"></HeaderStyle>
                ...
                <div class="encabezado">
                    <label class="titulos" style="margin-bottom:10px"><b>Actualizar datos </b></label>

                    <div class="formatoTitulo" style="margin-bottom:5px">
                            <label class="titulos"><b>Oficial</b></label>
                            <label class="titulos" style="margin-left:48%"><b>Notificador</b></label>
                        </div>
                         <div class="formato">
                             <asp:DropDownList id="Oficial2" runat="server" class="formatoinput" AutoPostBack="false"></asp:DropDownList>
                             <asp:DropDownList id="Notificador2" runat="server" class="formatoinput" AutoPostBack="false"></asp:DropDownList>
                        </div><br /><br />

                    <div class="formatoTitulo" style="margin-bottom:5px">
                            <label class="titulos"><b>No. Juzgado</b></label>
                            <label class="titulos" style="margin-left:42%"><b>Nombre Juzgado</b></label>
                        </div>
                        <div class="formato">
                            <input id="NumJuzgado2" runat="server" type="text" class="formatoinput" placeholder="Ingrese no. juzgado" maxlength="11" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                            <input id="NombreJuzgado2" runat="server" type="text" class="formatoinput" onkeypress="return sololetras(event);" placeholder="Ingrese nombre juzgado" maxlength="50" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div><br />

                    <label class="titulos" style="margin-bottom:10px"><b>Actualización de documentos </b></label>
