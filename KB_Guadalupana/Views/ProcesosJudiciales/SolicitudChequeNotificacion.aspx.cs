...
{
    public partial class SolicitudChequeNotificacion : System.Web.UI.Page
    {
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sn.insertarsolicitudcheque(sig, numcredito, idusuario, NumCheque.Value, FechaEmision.Value, Banco.SelectedValue, ObservacionesCredito.Value, Monto.Value, "27");
                ...
                sn.cambiarestado(numcredito, "22");

                string sig2 = sn.siguiente("pj_etapa_credito", "idpj_correlativo_etapa");
                sn.guardaretapa(sig2, "23", numcredito, sn.datetime(), "Cargar Voucher", idusuario, "28", nombrecliente2, NumeroIncidente.Value);
        ...
        protected void Enviar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               sn.estadodevuelto(numcredito, "28", "26");
