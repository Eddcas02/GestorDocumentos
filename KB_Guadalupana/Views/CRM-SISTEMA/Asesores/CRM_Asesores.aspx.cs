    ...
    public partial class CRM_Asesores : System.Web.UI.Page
    {
        ...
        public void llenargridviewprospecto(string usuario)
        {
            using (MySqlConnection sqlCon = new MySqlConnection(cn.cadenadeconexion()))
            {
                ...
                {
                    sqlCon.Open();
                    string QueryString = "select a.codcrminfoprospecto,a.codcrminfogeneralprospecto,b.crminfogeneral_prospectodpi,b.crminfogeneral_prospectonombrecompleto,a.crminfo_prospectotelefono, a.crminfo_prospectoemail,a.crminfo_prospectoingresos,a.crminfo_prospectoegresos,a.crminfo_prospectoañoslaborados,a.crminfo_prospectotrabajaactualmente," +
                    " a.crminfo_prospectodescripciontrabajoactual,a.codcrmtiposervicio,a.crminfo_prospectomonto,a.codcrmfinalidadservicio,a.codcrmcontactollamadas, a.crminfo_prospectofechaprimerllamada,a.crminfo_prospectofechaultimallamada,a.codcrmsemaforoestado,a.codcrmestadodescripcion,a.crminfo_prospectocuentaconigss, a.codcrmtipodomicilio,a.crminfo_prospectoañosdomicilio," +
                    " a.crminfo_prospectocuentaencooperativa,a.crminfo_prospectosucursalcerca,a.crminfo_prospectodescripcion, a.crminfo_contactadopor,a.crminfo_prospectoreferenciado, e.crmsemaforo_estadonombre, f.crmestado_descripcionnombre FROM crminfo_prospecto a INNER JOIN crminfogeneral_prospecto b INNER JOIN crmcontrol_prospecto_agente c INNER JOIN crmcontrol_ingreso d" +
                    " INNER JOIN crmsemaforo_estado e INNER JOIN crmestado_descripcion f ON a.codcrminfogeneralprospecto = b.codcrminfogeneralprospecto AND c.codcrminfoprospecto = a.codcrminfoprospecto AND c.codcrmcontrolingreso = d.codcrmcontrolingreso AND a.codcrmsemaforoestado = e.codcrmsemaforoestado AND a.codcrmestadodescripcion = f.codcrmestadodescripcion WHERE d.crmcontrol_ingresousuario = '"+usuario+"' AND(a.codcrmsemaforoestado = 2 OR a.codcrmsemaforoestado = 3)";
        ...
        protected void Btn_Guardarprospecto_Click(object sender, EventArgs e)
        {
            ...
            {
                if (combosemaforoestado.SelectedValue == "3")
                {
                    efectuarcambio();
                }
                else
        ...
        public void efectuarcambio()
        {
            ...
            try
            {
                ...
                logic.modificartablas("crminfogeneral_prospecto", campos1, valores1);
                logic.bitacoraingresoprocedimientos("usuario", "CRM", "Aplicación Asesores", "Modificado de un prospecto - Correlativo : '" + txtnumerodpi.Value + "'");
                String script = "alert('Datos modificados exitosamente');";
                ScriptManager.RegisterStartupScript(this, GetType().GetType(), "alertMessage", script, true);
            }
            catch
            {
        ...
        public void llenargridviewprospectousuarioconsubestado(string usuario, string subestado)
        {
            using (MySqlConnection sqlCon = new MySqlConnection(cn.cadenadeconexion()))
            {
                ...
                {
                    sqlCon.Open();
                    string QueryString = "select a.codcrminfoprospecto,a.codcrminfogeneralprospecto,b.crminfogeneral_prospectodpi,b.crminfogeneral_prospectonombrecompleto,a.crminfo_prospectotelefono,a.crminfo_prospectoemail,a.crminfo_prospectoingresos,a.crminfo_prospectoegresos,a.crminfo_prospectoañoslaborados,a.crminfo_prospectotrabajaactualmente,a.crminfo_prospectodescripciontrabajoactual,a.codcrmtiposervicio,a.crminfo_prospectomonto,a.codcrmfinalidadservicio,a.codcrmcontactollamadas,a.crminfo_prospectofechaprimerllamada,a.crminfo_prospectofechaultimallamada,a.codcrmsemaforoestado,a.codcrmestadodescripcion,a.crminfo_prospectocuentaconigss,a.codcrmtipodomicilio,a.crminfo_prospectoañosdomicilio,a.crminfo_prospectocuentaencooperativa,a.crminfo_prospectosucursalcerca,a.crminfo_prospectodescripcion,a.crminfo_contactadopor,a.crminfo_prospectoreferenciado,e.crmsemaforo_estadonombre, f.crmestado_descripcionnombre FROM crminfo_prospecto a INNER JOIN crminfogeneral_prospecto b INNER JOIN crmcontrol_prospecto_agente c INNER JOIN crmcontrol_ingreso d INNER JOIN crmsemaforo_estado e INNER JOIN crmestado_descripcion f ON a.codcrminfogeneralprospecto=b.codcrminfogeneralprospecto AND c.codcrminfoprospecto=a.codcrminfoprospecto AND c.codcrmcontrolingreso=d.codcrmcontrolingreso AND a.codcrmsemaforoestado = e.codcrmsemaforoestado AND a.codcrmestadodescripcion = f.codcrmestadodescripcion WHERE d.crmcontrol_ingresousuario='" + usuario + "'  AND a.codcrmestadodescripcion='" + subestado + "' AND (a.codcrmsemaforoestado=2 OR a.codcrmsemaforoestado=3);";
                    MySqlDataAdapter command = new MySqlDataAdapter(QueryString, sqlCon);
                    DataTable ds3 = new DataTable();
                    command.Fill(ds3);
