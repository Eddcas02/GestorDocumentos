...
<body>
  ...
  <div class="row">
    ...
    AutoGenerateColumns="False" BorderStyle="Solid"  AllowPaging="true" PageSize="2000" OnPageIndexChanging="DGVCONHALLAZGO_PageIndexChanging" OnSelectedIndexChanged="DGVCONHALLAZGO_SelectedIndexChanged" >
                    <Columns>
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Fecha/Hora Desembolso">
                           <ItemTemplate>
                           <asp:Label ID="lblfecha"  Width="150px" Text='<%# Eval("gen_fechadesembolso") %>' runat="server" />
    ...
    AutoGenerateColumns="False" BorderStyle="Solid" AllowPaging="true" PageSize="15" OnPageIndexChanging="DGVOREN_PageIndexChanging" >
                    <Columns>
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="Fecha/Hora Desembolso">
                           <ItemTemplate>
                           <asp:Label ID="lblfecha"  Width="150px" Text='<%# Eval("gen_fechadesembolso") %>' runat="server" />
