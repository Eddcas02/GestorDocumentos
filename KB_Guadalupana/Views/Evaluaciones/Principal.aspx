           ...
           <div class="form-group" style="text-align: center">
            ...
            <div class="container">
                    ...
                    <div id="REPORTESS" runat="server">
                        ...
                        <ContentTemplate>
                                 <asp:LinkButton ID="generarrepo" runat="server" CssClass="custom-btn btn-8" Text="Generar Reporte" OnClick="generarrepo_Click" style="text-align:center; text-decoration:none;"> </asp:LinkButton>
                             <asp:LinkButton ID="generarreponotas" runat="server" CssClass="custom-btn btn-8" Text="Generar Reporte" OnClick="generarreponotas_Click" style="text-align:center; text-decoration:none;"> </asp:LinkButton>
                             <asp:LinkButton ID="generarpropio" runat="server" CssClass="custom-btn btn-8" Text="Generar Reporte" OnClick="generarpropio_Click" style="text-align:center; text-decoration:none;"> </asp:LinkButton>
                             <asp:LinkButton ID="jefegen" runat="server" CssClass="custom-btn btn-8" Text="Generar jefe" OnClick="jefegen_Click" style="text-align:center; text-decoration:none;"> </asp:LinkButton>
                             <asp:LinkButton ID="preguntass" runat="server" CssClass="custom-btn btn-8" Text="Generar jefe" OnClick="preguntas_Click" style="text-align:center; text-decoration:none;"> </asp:LinkButton>
                             <asp:LinkButton ID="notastodos" runat="server" CssClass="custom-btn btn-8" Text="Generar notas" OnClick="notastodos_Click" style="text-align:center; text-decoration:none;"> </asp:LinkButton>
                          
                            <div class="row"> 
                                <div class="col-lg-6">
                                               <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height =" 700px" ShowBackButton="False" ShowFindControls="False" ShowPageNavigationControls="False" ShowRefreshButton="False" ShowZoomControl="False">
                                ...
                                <div class="col-lg-6">
                                               <rsweb:ReportViewer ID="ReportViewer2" runat="server" Width="100%" Height =" 700px">
