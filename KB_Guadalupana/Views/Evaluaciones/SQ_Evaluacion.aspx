...
<body>
    <form id="msform" style="width:90%; height:100%; display: flex;align-items: center;align-content: center;justify-content: center;flex-direction: column;" runat="server">
        ...
        <h3>Seleccione persona a evaluar: </h3>
          <asp:DropDownList  ID="Persona" runat="server" CssClass="dis" Width="177px" AutoPostBack="true"  OnSelectedIndexChanged="Persona_SelectedIndexChanged" ></asp:DropDownList>
  ...
  <fieldset>
    ...
    <input type="submit" name="submit" class="submit action-button" value="Submit" />
        ...
        <br /><br /><br /><br />
               ...
               <div id="tablapersonas" visible="false" runat="server" style=" height: 400px; width:50%; align-content:center;align-items:center;justify-content:center">
                           <asp:Label ID="lbll" Visible="false" runat="server" CssClass="fs-title" Text="Personal con autoevaluación completa">  </asp:Label>    
                   <asp:GridView ID="gridViewPersonas" Visible="false" runat="server" CssClass="tabla" AutoGenerateColumns="False" ForeColor="Black" Width="100%"
                            BorderStyle="Solid">
                            <Columns>
