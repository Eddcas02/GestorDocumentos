...
namespace KB_Guadalupana.Views.Evaluaciones
{
    public partial class Principal : System.Web.UI.Page
    {
        ...
        string horamin, fechamin2, fechahora2, fechatotal1, fechatotal2, ususario;
        char delimitador = ' ';
        char delimitador3 = ':';
        char delimitador4 = '/';
        string concat = "T";
        protected void Page_Load(object sender, EventArgs e)
        {
            now();
            now2();
            ususario = Convert.ToString(Session["sesion_usuario"] = "pgecasasola");
            if (!IsPostBack) {
                llenarcomboevaluado();
        ...
        protected void jefegen_Click(object sender, EventArgs e)
        {
        ...
        {
            ReportViewer1.Reset();
            ReportDataSource fuente = new ReportDataSource("preguntasescalas", preguntasjefe());
        ...
        {
            ReportViewer1.Reset();
            ReportDataSource fuente = new ReportDataSource("resultados", notastodos2());
        ...
        protected void generarpropio_Click(object sender, EventArgs e)
        {
            ReportViewer1.Reset();
            ReportDataSource fuente = new ReportDataSource("auto15", auto15());
            ReportDataSource fuente2 = new ReportDataSource("auto613", auto613());
